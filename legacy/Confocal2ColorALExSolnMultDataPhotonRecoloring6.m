function [appData, handles, ERRORFLG] = Confocal2ColorALExSolnMultDataPhotonRecoloring6(...
    appData, handles)
%
...
%% FIGURES:
tagLine = ' Acceptor Blinking ';
statePair = '(2E, 2S)';
states = '(S0.7,1.0, E0.5,0.0)';
rates = '(1000,10000)';
svgLine = 'acceptorblinking_k1000_k10000';
...
save(['Simulation - Photon Recoloring - ES Corr - ', tagLine, statePair, states, rates, '(W', int2str(WINDOW), 'C',int2str(CORRWINDOW),')(2012-08-08)(1).mat'],...
    'bca',...
    'eStateMeans',...
    'sStateMeans',...
